  ...
  return (
    <>
      ...
      <div className="flex flex-col rounded-lg shadow-sm bg-white overflow-hidden dark:text-gray-100 dark:bg-gray-800">
        {/* Card Header */}
        <div className="py-4 px-5 bg-gray-50 text-center space-y-3 sm:space-y-0 sm:text-left sm:flex sm:justify-between sm:items-center dark:bg-gray-900">
          <div>
        ...
        {/* Card Footer */}
        <div className="py-2 px-5 bg-gray-50 grid grid-cols-3 text-center dark:bg-gray-900">
          <dl className="py-1 space-y-1">
